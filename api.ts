...
export const StrategiesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        noneStrategyGet: async (id: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('noneStrategyGet', 'id', id)
         ...
         * @throws {RequiredError}
         */
        noneStrategyGetAll: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const StrategiesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async noneStrategyGet(id: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.noneStrategyGet(id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async noneStrategyGetAll(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<object>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.noneStrategyGetAll(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Standard (1 Vote = 1 Vote)
...
export const StrategiesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        noneStrategyGet(id: any, options?: any): AxiosPromise<object> {
            return localVarFp.noneStrategyGet(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        noneStrategyGetAll(options?: any): AxiosPromise<Array<object>> {
            return localVarFp.noneStrategyGetAll(options).then((request) => request(axios, basePath));
        },
        /**
         * Standard (1 Vote = 1 Vote)
         * @summary 
...
export interface StrategiesApiInterface {
     ...
     * @memberof StrategiesApiInterface
     */
    noneStrategyGet(id: any, options?: AxiosRequestConfig): AxiosPromise<object>;
     ...
     * @memberof StrategiesApiInterface
     */
    noneStrategyGetAll(options?: AxiosRequestConfig): AxiosPromise<Array<object>>;
...
export class StrategiesApi extends BaseAPI implements StrategiesApiInterface {
     ...
     * @memberof StrategiesApi
     */
    public noneStrategyGet(id: any, options?: AxiosRequestConfig) {
        return StrategiesApiFp(this.configuration).noneStrategyGet(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof StrategiesApi
     */
    public noneStrategyGetAll(options?: AxiosRequestConfig) {
        return StrategiesApiFp(this.configuration).noneStrategyGetAll(options).then((request) => request(this.axios, this.basePath));
    }
