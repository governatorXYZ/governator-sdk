...
export const StrategiesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * POAP - Event gated - gnosis & mainnet
         * @summary 
         * @param {StrategyRequestDto} strategyRequestDto 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        poapEventStrategyPost: async (strategyRequestDto: StrategyRequestDto, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'strategyRequestDto' is not null or undefined
            assertParamExists('poapEventStrategyPost', 'strategyRequestDto', strategyRequestDto)
            const localVarPath = `/api/strategies/poap-event-gated-gnosis-mainnet`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        strategyControllerGetAll: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        strategyControllerGetOne: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('strategyControllerGetOne', 'id', id)
...
export const StrategiesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async poapEventStrategyPost(strategyRequestDto: StrategyRequestDto, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.poapEventStrategyPost(strategyRequestDto, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async strategyControllerGetAll(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<StrategyResponseDto>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.strategyControllerGetAll(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async strategyControllerGetOne(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StrategyResponseDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.strategyControllerGetOne(id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const StrategiesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        poapEventStrategyPost(strategyRequestDto: StrategyRequestDto, options?: any): AxiosPromise<string> {
            return localVarFp.poapEventStrategyPost(strategyRequestDto, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        strategyControllerGetAll(options?: any): AxiosPromise<Array<StrategyResponseDto>> {
            return localVarFp.strategyControllerGetAll(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id Strategy ID
         ...
         * @throws {RequiredError}
         */
        strategyControllerGetOne(id: string, options?: any): AxiosPromise<StrategyResponseDto> {
            return localVarFp.strategyControllerGetOne(id, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface StrategiesApiInterface {
     ...
     * @memberof StrategiesApiInterface
     */
    poapEventStrategyPost(strategyRequestDto: StrategyRequestDto, options?: AxiosRequestConfig): AxiosPromise<string>;
     ...
     * @memberof StrategiesApiInterface
     */
    strategyControllerGetAll(options?: AxiosRequestConfig): AxiosPromise<Array<StrategyResponseDto>>;
     ...
     * @memberof StrategiesApiInterface
     */
    strategyControllerGetOne(id: string, options?: AxiosRequestConfig): AxiosPromise<StrategyResponseDto>;
...
export class StrategiesApi extends BaseAPI implements StrategiesApiInterface {
     ...
     * @memberof StrategiesApi
     */
    public poapEventStrategyPost(strategyRequestDto: StrategyRequestDto, options?: AxiosRequestConfig) {
        return StrategiesApiFp(this.configuration).poapEventStrategyPost(strategyRequestDto, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof StrategiesApi
     */
    public strategyControllerGetAll(options?: AxiosRequestConfig) {
        return StrategiesApiFp(this.configuration).strategyControllerGetAll(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof StrategiesApi
     */
    public strategyControllerGetOne(id: string, options?: AxiosRequestConfig) {
        return StrategiesApiFp(this.configuration).strategyControllerGetOne(id, options).then((request) => request(this.axios, this.basePath));
    }
}
